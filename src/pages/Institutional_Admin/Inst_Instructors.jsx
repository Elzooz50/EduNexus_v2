...
const InstInstructors = () => {
  ...
  useEffect(() => {
    // TODO: Fetch instructors from backend
    // fetch('/api/inst-admin/instructors')
    //   .then(res => res.json())
      ...
      <main className="ia-main-content">
        ...
        <div className="ia-page-content">
          ...
          <div className="ia-page-header-section">
            ...
            <p className="ia-page-subtitle">Manage all instructors within the system, view their work and efficiently handle enrollment operations.</p>
          </div>
          ...
          <div className="ia-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="ia-modal-ready">
              ...
              <div>
                ...
                <p>{instructors.length} instructors be exported with {selectedCount} fields in EXCEL</p>
              </div>
            </div>
