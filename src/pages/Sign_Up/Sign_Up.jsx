...
const SignUp = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!trimmedData.ssn || !trimmedData.firstName || !trimmedData.lastName ||
        !trimmedData.email || !trimmedData.password || !trimmedData.confirmPassword) {
  ...
  const calculateProgress = () => {
    const fields = ['ssn', 'firstName', 'lastName', 'email', 'password', 'confirmPassword'];
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <input 
                  ...
                  className={`form-input ${fieldErrors.firstName ? 'input-error' : formData.firstName ? 'input-filled' : ''}`} 
                  required 
                />
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <input 
                  ...
                  className={`form-input ${fieldErrors.lastName ? 'input-error' : formData.lastName ? 'input-filled' : ''}`} 
                  required 
                />
          ...
          <div className="form-group">
            ...
            <div className="input-wrapper">
              <input 
                ...
                className={`form-input ${fieldErrors.email ? 'input-error' : formData.email ? 'input-filled' : ''}`} 
                required 
              />
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <input 
                  ...
                  className={`form-input ${fieldErrors.password ? 'input-error' : formData.password ? 'input-filled' : ''}`} 
                  required 
                />
                <span 
                  className="eye-icon" 
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <input 
                  ...
                  className={`form-input ${fieldErrors.confirmPassword ? 'input-error' : formData.confirmPassword ? 'input-filled' : ''}`} 
                  required 
                />
                <span 
                  className="eye-icon" 
