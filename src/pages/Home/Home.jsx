...
const Home = () => {
  ...
  React.useEffect(() => {
    ...
    if (!hasVisited && !isAuthenticated()) {
      navigate('/get_started', { replace: true });
    }
  }, [navigate]);

  const handleGetStarted = () => {
    const isAuthenticatedUser = Boolean(getAuthToken() || localStorage.getItem('token') || sessionStorage.getItem('user'));
    navigate(isAuthenticatedUser ? '/sign-up' : '/sign-up');
  };
